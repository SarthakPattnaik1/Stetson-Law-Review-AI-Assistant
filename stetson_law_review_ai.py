...
✅ Reads PDFs from Volume 30–55, even with random names.
✅ Uses OCR when available (Tesseract installed).
✅ Summarizes, ranks, and tracks articles beautifully.
"""
...
def extract_text_from_pdf(pdf_path):
    """Extract text; use OCR if available."""
    try:
